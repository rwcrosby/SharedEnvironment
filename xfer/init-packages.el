...
; Snippets
(setq yas-snippet-dirs '("~/Dropbox/Development/emacs/snippets"))
(yas-global-mode 1)
...
(setq reftex-default-bibliography '("~/Dropbox/Papers/rwc.bib"))
...
(setq org-mobile-inbox-for-pull "~/Dropbox/OrgMode/flagged.org")
(setq org-mobile-directory "~/Dropbox/Apps/MobileOrg")
(setq org-agenda-files '("~/Dropbox/Quartet/Quartet.org"
			 "~/Dropbox/Paml/Paml.org"
			 "~/Dropbox/OrgMode/Tamu.org"
			 "~/Dropbox/OrgMode/TodoList.org"
			 "~/Dropbox/FDivT/FDivT.org"))
...
(setq bookmark-default-file "~/Dropbox/Development/emacs/Bookmarks.bmk")

...
% Eliminate the titlepage entirely
...
\renewcommand{\maketitle}{%
  ...
  \vspace*{9pt}
  {
    \centerline{\Large \usefont{T1}{\sfdefault}{semibold}{n} \@title}
  }\par
  {
    \large \usefont{T1}{\sfdefault}{sb}{n} \@author
  }\par
  {
...
%----------------------------------------------------------------------------------------
%	Set the section heading style
%----------------------------------------------------------------------------------------

\usepackage{sectsty}
\allsectionsfont{\usefont{T1}{\sfdefault}{semibold}{n}}
